...
def get_default_config() -> dict:
    return {
        "model_name": "aefn_before_phi",
        "results_dir_name": "aefn_before_phi_results",
...
def build_model(config: dict, extra_info: dict | None = None):
    ...
    # -------------------------------------------------------
    # The raw particle coordinates are first embedded.
    x = Dense(
        attention_dim,
        activation=activation,
    ...
    # Self-attention between raw particle representations.
    ...
    # -------------------------------------------------------
    # Phi processes every contextualized particle separately.
...
def get_model_summary_fields(config: dict) -> dict:
    return {
        "model_name": config.get("model_name", "aefn_before_phi"),
